...
class Network(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(28*28, 16) # from 28x28 input image to hidden layer of size 256
        self.fc2 = nn.Linear(16,10) # from hidden layer to 10 class scores
...
num_epoch = 11 # TODO: Choose an appropriate number of training epochs
